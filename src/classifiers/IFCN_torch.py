...
class IFCN(nn.Module):
    ...
    def __init__(self, in_channels, out1_channels_1, out1_channels_2, out1_channels_3,
        ...
        # out1_channels_4(16), out2_channels_1(32), out2_channels_2(64), out2_channels_3(192), out2_channels_4(32)
...
class Inception_module(nn.Module):
    ...
    def __init__(self, in_channels, out_channels_1, out_channels_2,
        ...
        self.conv_1 = BasicConv2d(in_channels, out_channels_1, 1)  # 1，16

        self.conv_3 = BasicConv2d(in_channels, out_channels_2, 3)  # 1，32

        self.conv_3_3_a = BasicConv2d(in_channels, out_channels_3, 3)  # 1，96
        self.conv_3_3_b = BasicConv2d(out_channels_3, out_channels_3, 3)  # 96，96

        self.conv_3pool_1_3 = nn.MaxPool2d(3, 1, 3 // 2)
        self.conv_3pool_1_1 = BasicConv2d(in_channels, out_channels_4, 1)  # 1，16
...
def train_op(classifier_obj, EPOCH, batch_size, LR, train_x, train_y,
    ...
    for epoch in range(EPOCH):
        ...
        early_stopping = EarlyStopping(output_directory_models)
        early_stopping(loss_test, classifier_obj)
