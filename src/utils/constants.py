...
def parse_args():
      ...
      parser = argparse.ArgumentParser(description='LRFN')
      ...
      parser.add_argument('--UNIVARIATE_DATASET_NAMES', type=str, default='Car',
                          help='dataset name: can be all of the 85 UCR dataset names')
      parser.add_argument('--CLASSIFIERS', type=str, default='LRFN_torch', # RFPN_torch
...
def create_classifier(classifier_name, nb_classes):
    ...
    if classifier_name == 'RFPN_torch':
        from src.classifiers import RFPN_torch
        # __init__(self, in_channels, out1_channels_1, out1_channels_2, out1_channels_3,
        #          out1_channels_4, out2_channels_1, out2_channels_2, out2_channels_3,
        #          out2_channels_4, num_class)
        return RFPN_torch.RFPN(1, 16, 32, 64, nb_classes), RFPN_torch
    ...
    if classifier_name == 'LRFN_torch':
        from src.classifiers import LRFN_torch
        # __init__(self, in_channels, out1_channels_1, out1_channels_2, out1_channels_3,
        #          out1_channels_4, out2_channels_1, out2_channels_2, out2_channels_3,
        #          out2_channels_4, num_class)
        return LRFN_torch.LRFN(1, 16, 32, 96, 16, 32, 64, 192, 32, nb_classes), LRFN_torch